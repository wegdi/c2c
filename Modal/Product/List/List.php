...
if (isset($_POST["C2cCode"]) && $_POST["C2cCode"] !== "") {
...
if (isset($_POST["IdeaSoftSatatus"]) && $_POST["IdeaSoftSatatus"] !== "") {
  $filter["IdeaSoft"] = (int)$_POST["IdeaSoftSatatus"];
}

if (isset($_POST["IdeaSoftCategory"]) && $_POST["IdeaSoftCategory"] !== "") {
...
foreach ($Products as $ProductsGet) {
    ...
    $metaDescriptionWarning = empty($ProductsGet["product_meta_description"]) || is_null($ProductsGet["product_meta_description"]) ? '<span class="badge bg-warning"><i class="ri-error-warning-fill"></i></span>' : '';
