      ...
      <div class="card">
          ...
          <div class="card-body">
              <table id="MetaTable" class="display table table-bordered dt-responsive" style="width:100%">
                  <thead>
                      <tr>
                          <th><?php echo $Themes->Translate("TEXT_USER_IMAGE"); ?></th>
                          <th><?php echo $Themes->Translate("TEXT_USER_NAME"); ?></th>
                          <th><?php echo $Themes->Translate("TEXT_USER_MAIL"); ?></th>
                          <th><?php echo $Themes->Translate("TEXT_USER_STATUS"); ?></th>
                          <th><?php echo $Themes->Translate("TEXT_MENU_AUTHORITY"); ?></th>
                          <th></th>
                      </tr>
                  </thead>
