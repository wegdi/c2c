        ...
        <form id="feg">
          <div class="mt-4">
            <div class="input-group">
                ...
                <textarea class="form-control" aria-label="With textarea" rows="10" name="Message"></textarea>
            </div>
          </div>
          <div class="mt-4">
            ...
            <select required multiple="multiple" name="Groups[]" id="multiselect-header">
              ...
              <?php foreach ($Groups as $key => $GroupsGet): ?>
                <option value="<?php echo $GroupsGet['_id']->__toString(); ?>"><?php echo $GroupsGet["Name"]; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
