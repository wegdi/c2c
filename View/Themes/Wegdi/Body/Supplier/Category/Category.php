              ...
              <tr>
                ...
                <th colspan="3">
                  <div class="d-flex align-items-center">
                    ...
                    <p></p>
                    <button type="button" id="kaydet" onclick="FromSaveGlobal('#sendForm','/Modal/Supplier/Category/CategorySave.php',0)" form="sendForm" class="btn btn-primary ms-1">
                      <?php echo $Themes->Translate("BUTTON_REGISTER"); ?>
                    </button>
                  </div>
                  <div class="d-flex align-items-center mt-2">
                    <button type="button" id="kaydet" onclick="FromSaveGlobal('#sendForm','/Modal/Supplier/Category/CategoryCreate.php',0)" form="sendForm" class="btn btn-secondary w-100">
