      ...
      <div class="card">
          ...
          <div class="card-body">
              <table id="MetaTable" class="display table table-bordered dt-responsive" style="width:100%">
                  <thead>
                      <tr>
                          <th><?php echo $Themes->Translate("LOG_CONDITION"); ?></th>
                          <th><?php echo $Themes->Translate("LOG_MESSAGE"); ?></th>
                          <th><?php echo $Themes->Translate("LOG_IP"); ?></th>
                          <th><?php echo $Themes->Translate("LOG_DATE"); ?></th>
                      </tr>
                  </thead>
