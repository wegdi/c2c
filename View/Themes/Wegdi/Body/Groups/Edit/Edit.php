...
$Edit = $db->Query('Authority',["_id" => $db->ObjectId($param2)], [], 'TEK');
...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
  <h4 class="mb-sm-0"><?php echo $Themes->Translate("TEXT_GROUPS_EDIT"); ?></h4>

  <div class="page-title-right">
    <ol class="breadcrumb m-0">
      <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo $Themes->Translate("TEXT_GROUPS_BAR"); ?></a></li>
      <li class="breadcrumb-item active"><?php echo $Themes->Translate("TEXT_GROUPS_EDIT"); ?></li>
    </ol>
  </div>
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title mb-0"><?php echo $Themes->Translate("TEXT_GROUPS_EDIT"); ?></h5>
      </div>
      <div class="card-body">
        <form id="feg">
          ...
          <div  class="mt-3">
            ...
            <input type="text" class="form-control" id="basiInput" name="Name" required value="<?php echo $Edit["Name"]; ?>">
          </div>
                  ...
                  foreach ($ThemesConf as $ModalGet => $ModalIcGet) {
                    if (is_array($ModalIcGet)) {
                      ...
                      foreach ($ModalIcGet as $value) {
                        $check = (isset($Edit["Access"]) && is_array($Edit["Access"]) && in_array($ModalGet.'/'.$value, $Edit["Access"])) ? "checked" : "";
                        ?>

                        <div class="form-check mb-3">
                          <input class="form-check-input" <?php echo $check; ?> type="checkbox" id="formCheck<?php echo  $Number++; ?>" name="Access[]" value="<?php echo $ModalGet.'/'.$value; ?>" >
                      ...
                      $check = (isset($Edit["Access"]) && is_array($Edit["Access"]) && in_array($ModalGet.'/'.$ModalIcGet, $Edit["Access"])) ? "checked" : "";
                      ?>
                      <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" id="formCheck<?php echo  $Number++; ?>" name="Access[]"  value="<?php echo $ModalGet.'/'.$ModalIcGet; ?>">
                        <label class="form-check-label" for="formCheck<?php echo  $Number++; ?>">
