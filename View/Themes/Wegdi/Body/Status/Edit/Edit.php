...
$Edit = $db->Query('Status',["_id" => $db->ObjectId($param2)], [], 'TEK');
      ...
      <div class="card-body">
        ...
        <form id="feg">
          <div>
            ...
            <input type="text" class="form-control" id="basiInput" name="StatusName" required autocomplete="off" value="<?php echo $Edit["StatusName"]; ?>">
          </div>

          <div  class="mt-3">
            <label for="basiInput" class="form-label"><?php echo $Themes->Translate("LEADS_ICON"); ?> </label>
            <input type="text" class="form-control" id="basiInput" name="Icon" required autocomplete="off" value="<?php echo $Edit["Icon"]; ?>">
          </div>
          <div  class="mt-3">
            <label for="basiInput" class="form-label"><?php echo $Themes->Translate("LEADS_COLOR"); ?> </label>
            <input type="color" class="form-control" id="basiInput" name="Color" required autocomplete="off" value="#<?php echo $Edit["Color"]; ?>">
          </div>
